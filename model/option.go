...
func InitOptionMap() {
	...
	common.OptionMap["DashboardDefaultTimeRange"] = common.DashboardDefaultTimeRange
	common.OptionMap["DashboardAutoRefreshEnabled"] = strconv.FormatBool(common.DashboardAutoRefreshEnabled)
	common.OptionMap["DashboardRefreshIntervalSeconds"] = strconv.Itoa(common.DashboardRefreshIntervalSeconds)
	common.OptionMap["DashboardDefaultPageSize"] = strconv.Itoa(common.DashboardDefaultPageSize)
	common.OptionMap["DashboardDefaultHealthFilter"] = common.DashboardDefaultHealthFilter
	common.OptionMap["DashboardDefaultTrendMode"] = common.DashboardDefaultTrendMode
	common.OptionMap["DashboardDefaultChartTimeRangeDays"] = strconv.Itoa(common.DashboardDefaultChartTimeRangeDays)
	common.OptionMap["DashboardDefaultConsumptionChart"] = common.DashboardDefaultConsumptionChart
	...
	common.OptionMap["DashboardErrorRateCriticalThreshold"] = strconv.FormatFloat(common.DashboardErrorRateCriticalThreshold, 'f', -1, 64)
	common.OptionMap["DashboardSuccessRateGoodThreshold"] = strconv.FormatFloat(common.DashboardSuccessRateGoodThreshold, 'f', -1, 64)
	common.OptionMap["DashboardSuccessRateDegradedThreshold"] = strconv.FormatFloat(common.DashboardSuccessRateDegradedThreshold, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "DashboardAutoRefreshEnabled":
			common.DashboardAutoRefreshEnabled = boolValue
	...
	case "DashboardDefaultTimeRange":
		common.DashboardDefaultTimeRange = value
	case "DashboardRefreshIntervalSeconds":
		common.DashboardRefreshIntervalSeconds, _ = strconv.Atoi(value)
	case "DashboardDefaultPageSize":
		common.DashboardDefaultPageSize, _ = strconv.Atoi(value)
	case "DashboardDefaultHealthFilter":
		common.DashboardDefaultHealthFilter = value
	case "DashboardDefaultTrendMode":
		common.DashboardDefaultTrendMode = value
	case "DashboardDefaultChartTimeRangeDays":
		common.DashboardDefaultChartTimeRangeDays, _ = strconv.Atoi(value)
	case "DashboardDefaultConsumptionChart":
		common.DashboardDefaultConsumptionChart = value
	...
	case "SystemSettingsNavigation":
		common.SystemSettingsNavigation = value
	case "DashboardSlowFirstTokenThresholdMs":
		common.DashboardSlowFirstTokenThresholdMs, _ = strconv.Atoi(value)
	case "DashboardErrorRateWarningThreshold":
		common.DashboardErrorRateWarningThreshold, _ = strconv.ParseFloat(value, 64)
	case "DashboardErrorRateCriticalThreshold":
		common.DashboardErrorRateCriticalThreshold, _ = strconv.ParseFloat(value, 64)
	case "DashboardSuccessRateGoodThreshold":
		common.DashboardSuccessRateGoodThreshold, _ = strconv.ParseFloat(value, 64)
	case "DashboardSuccessRateDegradedThreshold":
		common.DashboardSuccessRateDegradedThreshold, _ = strconv.ParseFloat(value, 64)
	case "WorkerUrl":
