...
var DashboardRefreshIntervalSeconds = 5
var DashboardDefaultPageSize = 25
var DashboardDefaultHealthFilter = "all"
var DashboardDefaultTrendMode = "overview"
var DashboardDefaultChartTimeRangeDays = 1
var DashboardDefaultConsumptionChart = "bar"
...
var SystemSettingsNavigation = `{"order":["operations","models","site","auth","billing","security","content"],"areas":{"site":{"enabled":true,"order":["system-info","notice","header-navigation","sidebar-modules","settings-navigation"]},"auth":{"enabled":true,"order":["basic-auth","oauth","passkey","bot-protection","custom-oauth"]},"billing":{"enabled":true,"order":["quota","currency","model-pricing","group-pricing","payment","checkin"]},"models":{"enabled":true,"order":["overview","global","gemini","claude","grok","user-agents","client-identity","model-pricing","channel-affinity","model-deployment"]},"security":{"enabled":true,"order":["rate-limit","sensitive-words","ssrf","upstream-error-rules"]},"content":{"enabled":true,"order":["dashboard","appearance","announcements","api-info","faq","uptime-kuma","chat","drawing"]},"operations":{"enabled":true,"order":["overview","behavior","monitoring","email","worker","logs","performance","update-checker"]}}}`
...
var DashboardSuccessRateGoodThreshold = 95.0
var DashboardSuccessRateDegradedThreshold = 85.0
...
var RelayFirstByteTimeout int // unit is second
