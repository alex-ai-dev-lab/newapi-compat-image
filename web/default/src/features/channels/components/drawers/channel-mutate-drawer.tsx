                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder='claude-cli/2.1.80 (external, cli)' {...field} />
                              </FormControl>
                              <FormDescription>
                          ...
                          render={({ field }) => (
                            <FormItem className='flex items-center justify-between rounded-md border p-3'>
                              <div className='space-y-0.5'>
                                ...
                                <FormDescription>
                                  {t('Return fixed client-facing error messages while keeping sanitized logs.')}
                                </FormDescription>
                              </div>
                              <FormControl>
                                <Switch
                          ...
                          render={({ field }) => (
                            <FormItem className='flex items-center justify-between rounded-md border p-3'>
                              <div className='space-y-0.5'>
                                ...
                                <FormDescription>
                                  {t('Enabled by default. Disable only for channels that cannot follow guard validation.')}
                                </FormDescription>
                              </div>
                              <FormControl>
                                <Switch
                          ...
                          render={({ field }) => (
                            <FormItem className='flex items-center justify-between rounded-md border p-3'>
                              <div className='space-y-0.5'>
                                ...
                                <FormDescription>
                                  {t('Grey rollout only. The upstream must echo a hidden nonce at the beginning of normal text responses, otherwise the channel is blocked and marked risky.')}
                                </FormDescription>
                              </div>
                              <FormControl>
                                <Switch
                          ...
                          render={({ field }) => (
                            <FormItem className='flex items-center justify-between rounded-md border p-3'>
                              <div className='space-y-0.5'>
                                ...
                                <FormDescription>
                                  {t('Validate response id/model/object/finish_reason fingerprint. Catches malformed or mismatched responses.')}
                                </FormDescription>
                              </div>
                              <FormControl>
                                <Switch
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <div className='space-y-2 rounded-md border p-3'>
                                ...
                                <FormDescription>
                                  {t('Enabled by default for OpenAI-style requests. Force disabled only for channels that reject Codex client metadata.')}
                                </FormDescription>
                                <Select
                                  value={field.value || 'auto'}
                                  onValueChange={(value) =>
                                    field.onChange(value ?? 'auto')
                                  }
                                >
                                  <FormControl>
                                    <SelectTrigger>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <div className='space-y-2 rounded-md border p-3'>
                                ...
                                <FormDescription>
                                  {t('Auto infers support from channel type. Explicit values override inference.')}
                                </FormDescription>
                                <Select
                                  value={field.value || 'auto'}
                                  onValueChange={(value) =>
