...
export function Features(_props: FeaturesProps) {
  ...
  const features = [
        ...
        <div className='mt-4 grid grid-cols-3 gap-2'>
          {['OpenAI', 'Claude', 'Gemini', 'DeepSeek', 'Qwen', 'Llama'].map(
            (name) => (
              <div
                key={name}
                className='border-border/30 bg-muted/20 text-muted-foreground hover:border-border hover:bg-muted/40 flex items-center justify-center rounded-lg border px-3 py-2 text-xs transition-colors duration-300'
              >
                {name}
              </div>
            )
      ...
      visual: (
        <div className='mt-4 flex items-center justify-center'>
          <div className='relative'>
            <div className='border-success/20 bg-success/5 flex size-16 items-center justify-center rounded-xl border'>
              <Shield
                className='text-success/70 size-7'
                strokeWidth={1.5}
              />
            </div>
    ...
    },
    {
      ...
      span: 'md:col-span-1',
      icon: <Globe className='text-chart-1 size-4' />,
      visual: (
