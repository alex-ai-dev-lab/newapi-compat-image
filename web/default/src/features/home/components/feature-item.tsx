  ...
  return (
    <div className='group/feature text-foreground flex flex-col gap-4 p-4'>
      ...
      <div className='flex items-center self-start'>
        <div className='bg-chart-1/10 ring-chart-1/20 group-hover/feature:ring-chart-1/40 flex h-10 w-10 items-center justify-center rounded-xl ring-1 transition-all duration-300 group-hover/feature:scale-110'>
          {icon}
        </div>
      </div>
      {/* Title */}
