...
export function FormDirtyIndicator({
  ...
  return (
    <SettingsPageTitleStatusPortal>
      <span className='bg-warning/10 text-warning inline-flex h-5 items-center gap-1.5 rounded-full px-2 text-[11px] font-medium whitespace-nowrap ring-1 ring-warning/20 ring-inset'>
