...
export type ContentSettings = {
  'theme.customization_preset': string
  'theme.customization_font': string
  'theme.customization_radius': string
  'theme.customization_scale': string
  'theme.content_layout': string
  'theme.custom_accent_enabled': boolean
  'theme.custom_accent_color': string
  'theme.custom_palette_enabled': boolean
  'theme.custom_background_color': string
  'theme.custom_surface_color': string
  'theme.custom_sidebar_color': string
  'theme.custom_chart_color': string
  ...
  DashboardDefaultTimeRange: string
  DashboardAutoRefreshEnabled: boolean
  DashboardRefreshIntervalSeconds: number
  DashboardDefaultPageSize: number
  DashboardDefaultHealthFilter: string
  DashboardDefaultTrendMode: string
  DashboardDefaultChartTimeRangeDays: number
  DashboardDefaultConsumptionChart: string
  DashboardDefaultModelAnalyticsChart: string
  DashboardVisibleSections: string
  DashboardSlowFirstTokenThresholdMs: number
  DashboardErrorRateWarningThreshold: number
  DashboardErrorRateCriticalThreshold: number
  DashboardSuccessRateGoodThreshold: number
  DashboardSuccessRateDegradedThreshold: number
  Chats: string
  ...
  // Navigation config (migrated from site area)
...
export type OperationsSettings = {
  ...
  // Uptime Kuma (migrated from content area)
...
export type OfficialPriceSyncStatus = {
...
export type OfficialPriceSyncStatusResponse = {
  success: boolean
  message: string
  data: OfficialPriceSyncStatus
}

export type OfficialPriceSyncTriggerResponse = {
  success: boolean
  message: string
  data: {
    added_models?: number
