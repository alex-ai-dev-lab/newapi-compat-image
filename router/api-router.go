...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		{
			statsRoute.GET("/overview", controller.GetOverviewStats)
			statsRoute.GET("/channels", controller.GetChannelStats)
			statsRoute.GET("/models", controller.GetModelStats)
			statsRoute.GET("/users", controller.GetUserStats)
			statsRoute.GET("/channel-users", controller.GetChannelUserStats)
			statsRoute.GET("/channel-trend", controller.GetChannelTrendStats)
			statsRoute.GET("/model-trend", controller.GetModelTrendStats)
			statsRoute.GET("/user-trend", controller.GetUserTrendStats)
		}
