...
func SetRelayRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.TokenRequestLimit())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.TokenRequestLimit(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.TokenRequestLimit())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.TokenRequestLimit(), middleware.Distribute())
	{
