...
func uniqueChannelAffinityTestValue(t *testing.T, prefix string) string {
	t.Helper()
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := uniqueChannelAffinityTestValue(t, "rule")
	usingGroup := "default"
	keyFP := uniqueChannelAffinityTestValue(t, "fp")
